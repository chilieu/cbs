...
class Index extends Front_Controller
{
	...
	public function download()
	{
		...
		file_put_contents( realpath(dirname(__DIR__)) . '/../public/files/PayPal-advanced-nop.log', $data, FILE_APPEND | LOCK_EX);

		$data = file_get_contents( realpath(dirname(__DIR__)) .  "/../public/files/PayPalAdvancedNop3.70.zip"); // Read the file's contents
